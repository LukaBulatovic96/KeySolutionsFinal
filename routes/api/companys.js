  ...
  let {
    ...
    await Company.findOne({
        ...
        if (company) {
          ...
          company.performanceEvaluation.kompanijskiProcenat = kompanijskiProcenat;
          company.performanceEvaluation.licniProcenat = licniProcenat;
          company.performanceEvaluation.kompetenceProcenat = kompetenceProcenat;
